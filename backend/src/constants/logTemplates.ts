export const LOG_TEMPLATES = {
  ...
  CalibrationPlan: ["CalibrationPlan.create", "CalibrationPlan.update", "CalibrationPlan.status", "CalibrationPlan.export", "CalibrationPlan.reschedule", "CalibrationPlan.batchReschedule"],
